TASK_LIST = [
    'Нарисовать сигну с именем Weloxd где угодно, можно на руке, можно на бумаге, можно на жопе.',
    ...
    'Купить Monster энергетик',
    'Пока-кать. Блять да у этого бота актив как у пятиклассницы, кошмар'
]
